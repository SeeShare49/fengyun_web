...
class AopClient {
	...
	public function sdkExecute($request) {
		\think\facade\Log::write("sdk execute sign type :".$this->signType);
	...
	*/
	public function pageExecute($request,$httpmethod = "POST") {
		...
		//签名
        \think\facade\Log::write("签名参数：");
        var_dump($totalParams);
        \think\facade\Log::write("签名类型：".$this->signType);
