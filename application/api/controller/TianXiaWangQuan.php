...
class TianXiaWangQuan
{
    public function index()
    {
        Log::write("天下王权游戏请求来了....");
        ...
        if (isset($param)) {
            ...
            $data['order_id'] =  'TXWQ_' . $user_id . date('YmdHis');//渠道ID_+用户ID+日期、
    ...
    public function notify_url()
    {
        ...
        if (isset($result)) {
            ...
            if ($ret_str['message']['status'] == "0") {
                ...
                try {
                    ...
                    if ($info && $info['order_status'] == 0) {
                        ...
                        $update['remark'] = '天下王权交易号【trade_no】:' . $orderNumber;
            ...
            Log::write("天下王权支付回调参数错误!!!");
        }
    }

    public function test()
    {
        $xml = '<?xml version="1.0" encoding="UTF-8" standalone="no"?><quicksdk_message><message><is_test>0</is_test><channel>1672</channel><channel_name></channel_name><channel_uid>599047</channel_uid><channel_order>202111260933158629</channel_order><game_order>TXWQ_429497730720211126093314</game_order><order_no>167220211126093315605636403</order_no><pay_time>2021-11-26 09:33:17</pay_time><amount>10.00</amount><status>0</status><extras_params>1672</extras_params></message></quicksdk_message>';
/*        $xml= '<?xml version="1.0" encoding="UTF-8" standalone="no"?><quicksdk_message><message><is_test>1</is_test><channel>0</channel><channel_name></channel_name><channel_uid>fa820cc1ad39a4e99283e9fa555035ec@_()</channel_uid><channel_order></channel_order><game_order>TXWQ_429497730220211125115759</game_order><order_no>00020211125115759621778623</order_no><pay_time>2021-11-25 11:57:59</pay_time><amount>10.00</amount><status>0</status><extras_params></extras_params></message></quicksdk_message>';*/
        $ret_str = $this->xml_to_data($xml);
        var_dump($ret_str);

        var_dump(is_array($ret_str));
        var_dump("status:".$ret_str['message']['status']);

        var_dump(  $ret_str['message']['game_order']);
        var_dump(  $ret_str['message']['order_no']);
    }
