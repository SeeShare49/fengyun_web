...
class DuDuWan
{
    public function index()
    {
        ...
        if (isset($param)) {
            ...
            $data['order_id'] = 'DDW_' . $user_id . date('YmdHis');//渠道ID_+用户ID+日期、
    ...
    public function notify_url()
    {
        ...
        if (isset($result)) {
            $call_back_key = '40268782549208727994820307335929';
            ...
            if ($ret_str['message']['status'] == "0") {
                ...
                try {
                    ...
                    if ($info && $info['order_status'] == 0) {
                        ...
                        $new_data['remark'] = '嘟嘟玩交易号【trade_no】:' . $orderNumber;
                        ...
                        $update['remark'] = '嘟嘟玩交易号【trade_no】:' . $orderNumber;
