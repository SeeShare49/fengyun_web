...
class RenXin
{
    public function index()
    {
        ...
        if (isset($param)) {
            ...
            $data['order_id'] = 'RX_' . $user_id . date('YmdHis');//渠道ID_+用户ID+日期、
    ...
    public function notify_url()
    {
        ...
        if (isset($result)) {
            $call_back_key = '73989715037446183500173079376843';
            ...
            if ($ret_str['message']['status'] == "0") {
                ...
                try {
                    ...
                    if ($info && $info['order_status'] == 0) {
                        ...
                        $new_data['remark'] = '刃心游戏交易号【trade_no】:' . $orderNumber;
                        ...
                        $update['remark'] = '刃心游戏交易号【trade_no】:' . $orderNumber;
