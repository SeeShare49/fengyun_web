...
class HuanJuYou
{
    public function index()
    {
        ...
        if (isset($param)) {
            ...
            $data['order_id'] = 'HJY_' . $user_id . date('YmdHis');//渠道ID_+用户ID+日期、
    ...
    public function notify_url()
    {
        ...
        if (isset($result)) {
            $call_back_key = '36498025326140378390794812214477';
            ...
            if ($ret_str['message']['status'] == "0") {
                ...
                try {
                    ...
                    if ($info && $info['order_status'] == 0) {
                        ...
                        $new_data['remark'] = '欢聚游戏交易号【trade_no】:' . $orderNumber;
                        ...
                        $update['remark'] = '欢聚游戏交易号【trade_no】:' . $orderNumber;
