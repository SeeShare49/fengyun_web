...
class DuoQu
{
    public function index()
    {
        ...
        if (isset($param)) {
            ...
            $data['order_id'] = 'DQ_' . $user_id . date('YmdHis');//渠道ID_+用户ID+日期、
    ...
    public function notify_url()
    {
        ...
        if (isset($result)) {
            $call_back_key = '44056070033581194478491991787822';
            ...
            if ($ret_str['message']['status'] == "0") {
                ...
                try {
                    ...
                    if ($info && $info['order_status'] == 0) {
                        ...
                        $new_data['remark'] = '多趣游戏交易号【trade_no】:' . $orderNumber;
                        ...
                        $update['remark'] = '多趣游戏交易号【trade_no】:' . $orderNumber;
